...
# the output will be printed to your chia root path, e.g. ~/.heather/mainnet/profile/
# to analyze the profile, run:

#   python chia/utils/profiler.py ~/.heather/mainnet/profile | less -r
...
#   python chia/utils/profiler.py ~/.heather/mainnet/profile 10 20
