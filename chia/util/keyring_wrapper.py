...
# the new passphrase.
DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE = "$ heather passphrase set # all the cool kids are doing it!"

MASTER_PASSPHRASE_SERVICE_NAME = "Heather Passphrase"
MASTER_PASSPHRASE_USER_NAME = "Heather Passphrase"
...
class KeyringWrapper:
    ...
    def confirm_migration(self) -> bool:
        ...
        if master_passphrase == DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE:
            ...
            print(
                "Would you like to set a master passphrase now? Use 'heather passphrase set' to change the passphrase.\n"
            )
            ...
            if response:
                ...
                print(
                    "Will skip setting a master passphrase. Use 'heather passphrase set' to set the master passphrase.\n"
                )
        else:
            import colorama
