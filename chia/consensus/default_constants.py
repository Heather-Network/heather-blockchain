...
testnet_kwargs = {
    ...
    "NUMBER_ZERO_BITS_PLOT_FILTER": 3,  # H(plot signature of the challenge) must start with these many zeroes (Mainnet 1/512 is 9, 3 is 1/4)
    ...
    "GENESIS_CHALLENGE": bytes.fromhex("de732855e76b8aa6f8b34fa0dbd2ea645fc6bb7a3cd3f9a9631bd53879cf500c"),
    ...
    "GENESIS_PRE_FARM_POOL_PUZZLE_HASH": bytes.fromhex(
        "96aa02dfda697268773a32dd61f39df80f82a36ca1e6a480a05742b189da9905"
    ),
    "GENESIS_PRE_FARM_FARMER_PUZZLE_HASH": bytes.fromhex(
        "d4c6404b6a44907db6e4fb51cb98645b27a863328f9f36a8df71f6b347917c08"
    ),
