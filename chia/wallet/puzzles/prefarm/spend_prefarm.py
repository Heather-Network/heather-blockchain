...
async def main() -> None:
    ...
    try:
        ...
        address1 = "heather1wa7nzx8cfmmc0d299km7ee0ezx8fk6agt57wzl6nvws5lm4pg3kqtune97"  # Key 1
        address2 = "heather1uu4y465sv34t5evc6wr0fn4xnfz3rkf9t0va2la5drt3pt4uc7ts3ej7nu"  # Key 2
        ...
        print(f"Ph1: {ph1.hex()}")
        print(f"Ph2: {ph2.hex()}")
        assert ph1.hex() == "a892e26c3e34a23759aadc4cfd532b2753d8996bdccad281fd4818bd060c97a7"
        assert ph2.hex() == "0bffceff1ad5edd7218a6aeab129101565c07edb97df3ed7647f7a67f8b66253"
