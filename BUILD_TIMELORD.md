...
required to run a [Timelord](https://github.com/Chia-Network/heather-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Chia-Network/heather-blockchain/blob/main/install-timelord.sh)
